...
/**
 * A list fragment representing a list of Clothes. This fragment also supports tablet devices by
 * allowing list items to be given an 'activated' state upon selection. This helps indicate which
 * item is currently being viewed in a {@link FragmentClotheDetail}.
 * <p>
 * Activities containing this fragment MUST implement the {@link Callbacks} interface.
 */
public class FragmentClotheList extends ListFragment {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setListAdapter(new ArrayAdapter<Clothe>(getActivity(), R.layout.activity_clothe_list,
